...
/**
 * sorts an array of numbers to a 2nd array using simple sorting method
 * @author Moustafa Eid
 * @version 13/12/2017
 */
public class S1E2B {
	/**
	 * a program that sorts an array of numbers to a 2nd array using simple sorting method
	 */
	public static void main(String[] args) {
		...
		int numberssorted [] = new int[8000];
		...
		for (int j = 0; j < max+1; j++) {
			// a for loop that goes through the index in sorted numbers
